...
经典SEIR模型将人群分为S (Susceptible，易感者)，I (Infected，感染者)，E (Exposed，潜伏者)和R (Recovered，康复人群)。该模型还假设人群中所有个体都有机率被感染，当被感染个体痊愈后，会产生抗体，即康复人群R不会再被感染。考虑到防治传染病的隔离措施，模型中的人群组分新增$S_q$ (隔离易感者)，$E_q$ (隔离潜伏者)和$I_q$ (隔离感染者)<sup>[3]</sup>。鉴于隔离感染者会立即送往定点医院隔离治疗，因此这部分人群在本模型中全部转化为住院患者H 代替。进而，原人群S，I，E 则分别指隔离措施遗漏的易感者、感染者和潜伏者。隔离易感者解除隔离后重新转变为易感者，而感染者和潜伏者均有不同程度的能力感染易感者，使其转化为潜伏者。
...
- 易感者数量S取自2018年意大利人口普查结果；
- 感染者数量I，考虑到意大利有关部门的疏漏等因素，我们使用2倍的拟合数据第0天的感染者数量作为I的初始值；
...
注意到预计感染曲线在23天左右与实际感染数据出现较大偏差。考虑该时间段大致为中国第一批援助团队到达日期，当地医疗资源紧张的情况有所缓解，被感染者隔离治疗速度加快，故在该日之后将 $ \delta_I $ 调整为原来的 $ 1.7 $ 倍：

<img src="simulate.svg" />

可以看出，预测曲线现在能较好的拟合实际数据。

根据预测结果，感染人数将在第 $ 50 $ 天左右（4月12日左右）达到顶峰，约 $ 16 $ 万人。此后，疫情将逐渐得到控制。
